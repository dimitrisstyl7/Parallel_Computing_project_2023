...
void *matricesMultiplication(void *arg) {
    ...
    /*
    Mutex are necessary for the following operation because
    multiple threads may try to access the same element of
    the array C, due to the fact that the elements of the
    array local_C are not distributed evenly among the threads.
    */
    for (int i = 0; i < N * M; i++) {
